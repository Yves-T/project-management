...
const Sidebar = () => {
  ...
  const sidebarClassNames = `fixed flex flex-col h-[100%] justify-between shadow-xl
    transition-all duration-300 h-full h-full z-40 dark:bg-black overflow-y-auto bg-white 
    ...
    <div className={sidebarClassNames}>
      <div className="flex h-[100%] w-full flex-col justify-start">
        ...
        <button
          ...
          className="w-ful flex items-center justify-between px-8 py-3 text-gray-500"
        >
